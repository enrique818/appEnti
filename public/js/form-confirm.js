...
window.initFormsConfirmation = function () {
  var dynamic = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  var formsConfirm = document.querySelectorAll('.axios-form-confirm');
  var formsConfirmDynamic = document.querySelectorAll('.axios-form-confirm-dyn');
  var canSend = true;

  var sendAxiosDataConfirm = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(axiosForm) {
      var axiosUrl, sendData, submitBtn, swalTime;
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return axios({
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          _context.next = 4;
                          return swalToastFire(result.data.message, swalTime).then(function () {
                            if (result.data.url) {
                              canSend = false;
                ...
                if (canSend) {// submitBtn.disabled = false;
                }
              });
    ...
    return function sendAxiosDataConfirm(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  var formEventFunction = function formEventFunction(e) {
    e.preventDefault();
    var axiosForm = e.currentTarget;
    var swalTitle = '¿Seguro que desea realizar la acción?';

    if (axiosForm.getAttribute('swal-title')) {
      swalTitle = axiosForm.getAttribute('swal-title');
    }

    var swalText = 'La acción no será reversible';
