...
window.initForms = function () {
  ...
  var forms = document.querySelectorAll('.axios-form');
  var formsDynamic = document.querySelectorAll('.axios-form-dyn');
  var validator = null;
  var currentFormId = '';
  var cantSend = false;

  var sendAxiosData = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(axiosForm) {
      var axiosUrl, sendData, submitBtn;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              axiosUrl = axiosForm.action;
              sendData = new FormData(axiosForm);
              submitBtn = axiosForm.querySelector('button[type="submit"]');
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          _context.next = 5;
                          return swalToastFire(result.data.message).then(function () {
                            if (result.data.url) {
                              cantSend = true;
    ...
    return function sendAxiosData(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  var formEventFunction = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4(e) {
      var axiosForm, validateOptionNumber, theValidationOptions;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              e.preventDefault();
              axiosForm = e.currentTarget;
              ...
              validateOptionNumber = axiosForm.getAttribute('validate-option');
              theValidationOptions = null; // Aqui se hará la comparación entre si se elige el total o un subarreglo, con un atributo de el formulario, tipo axiosForm.getAttribute('validate-option-index')
              ...
              _context4.next = 9;
              return FormValidation.formValidation(axiosForm, theValidationOptions);
            ...
            case 11:
              if (validator != null) {
                validator.validate().then( /*#__PURE__*/function () {
                  var _ref4 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3(status) {
    ...
    return function formEventFunction(_x3) {
