	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">Filtros X</h4>
			</div>
			<div class="card-body">
...
{{-- #EDITED 				@if(auth()->user()->perfil == 'startup' || auth()->user()->isAdmin)@endif --}}
					<div class="ms-4 mt-3 form-check form-switch form-check-custom form-check-solid">
...
<script>
	...
	let buscar = async () => {
		...
		await axios.get("{{route('conexiones.mine')}}", {
			params: {
				startup: startupVal,
				firma: firmaVal,
