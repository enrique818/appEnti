		...
		<div class="card h-100 mb-6">
			...
			<div class="card-body">
					<div class="w-100">
						...
						<h5 class="card-title">Perderás todos los datos, el contenido y el acceso que tengas relacionado a esta cuenta.</h5>
						<br>
						<button class="btn btn-rosa mx-2" id="del-count">Quiero eliminar mi cuenta</button>
					</div>
			</div>
		</div>
	</div>
